            ...
            <div class="col-lg-12 col-md-12 col-12 col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Form update selesai komplain klien</h4>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="alert-icon"><i class="fas fa-info-circle"></i></div>
                            <div class="alert-body">
                                ...
                                <form action="?page=complaintdone" method="post">
                        ...
                        if (isset($_POST['submit'])){
                            ...
                            $update = mysqli_query($conn,"UPDATE complent_issue SET status='done' WHERE id=$id");
                            if ($update){
